...
# Objetivo: Construir um modelo de Machine Learning para prever a nota de qualidade de um vinho (3 a 9) com base em características físico-químicas. 
# SMOTE é usado para lidar com o desbalanceamento das classes de qualidade.
